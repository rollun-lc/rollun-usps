...
class FixedPriceTest extends TestCase
{
    ...
    public function test_getShippingMetods_Null()
    {
        ...
        $this->assertEquals(
                ['id' => 'Md1', 'cost' => null, 'Error' => null, 'name' => ''], $fixedPrice->getShippingMetods($shippingRequest)->getArrayCopy()[0]
        );
    }
    ...
    public function test_getShippingMetods_99()
    {
        ...
        $this->assertEquals(
                ['id' => 'Md1', 'cost' => 20, 'Error' => null, 'name' => ''], $fixedPrice->getShippingMetods($shippingRequest)->getArrayCopy()[0]
        );
    }
}
