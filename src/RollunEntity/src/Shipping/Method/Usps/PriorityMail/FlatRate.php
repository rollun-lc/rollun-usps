...
class FlatRate extends ShippingsAbstract
{
    ...
    const USPS_BOXES
        = [
            ['PM-FR-Env', 'Priority Mail Flat Rate Envelope','PRIORITY COMMERCIAL', '', 'FLAT RATE ENVELOPE', 12.5, 12.5, 12.5, 70, 7.15],
            ['PM-FR-LegalEnv', 'Priority Mail Legal Flat Rate Envelope', 'PRIORITY COMMERCIAL', '', 'LEGAL FLAT RATE ENVELOPE', 15, 15, 15, 70, 7.45],
            ['PM-FR-Pad-Env', 'Priority Mail Flat Rate Padded Envelope', 'PRIORITY COMMERCIAL', '', 'PADDED FLAT RATE ENVELOPE', 12.5, 12.5, 12.5, 70, 7.75],
