...
class FlatRate extends ShippingsAbstract
{
    ...
    const USPS_BOXES
        = [
            ['PM-FR-Env', 'Priority Mail Flat Rate Envelope','PRIORITY COMMERCIAL', '', 'FLAT RATE ENVELOPE', 108, 108, 108, 70, 6.95],
            ['PM-FR-LegalEnv', 'Priority Mail Legal Flat Rate Envelope', 'PRIORITY COMMERCIAL', '', 'LEGAL FLAT RATE ENVELOPE', 108, 108, 108, 70, 7.45],
            ['PM-FR-Pad-Env', 'Priority Mail Flat Rate Padded Envelope', 'PRIORITY COMMERCIAL', '', 'PADDED FLAT RATE ENVELOPE', 108, 108, 108, 70, 7.75],
