...
class PackerApi
{
    ...
    {
        list($response) = $this->packWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation packWithHttpInfo
     *
     * Pack collection of items into collection of containers
     *
     ...
     */
    public function packAsync($body)
    {
        return $this->packAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation packAsyncWithHttpInfo
     *
     * Pack collection of items into collection of containers
     *
     * @param  \OpenAPI\Client\Model\Body $body (required)
     ...
     */
    protected function packRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling pack'
            );
        }

        $resourcePath = '/api/v1/pack';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
